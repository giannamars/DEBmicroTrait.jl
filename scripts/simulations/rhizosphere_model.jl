...
dosetimes = collect(1:100)
assimilation["LCMS"]
function affect!(integrator) 
    integrator.u[1:6] .+= spl_ex(integrator.t)
end
...
1+p.setup_pars.n_polymers+p.setup_pars.n_monomers+2*p.setup_pars.n_microbes+p.setup_pars.n_enzymes:p.setup_pars.n_polymers+p.setup_pars.n_monomers+2*p.setup_pars.n_microbes+p.setup_pars.n_enzymes+p.setup_pars.n_monomers