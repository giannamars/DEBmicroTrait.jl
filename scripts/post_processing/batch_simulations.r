...
# CUE
df_train <- read.csv("/Users/glmarschmann/.julia/dev/DEBmicroTrait_Full/files_old/isolates_batch_model_train.csv")
df_train$yield <- 1- df_train$yield
df_test <- read.csv("/Users/glmarschmann/.julia/dev/DEBmicroTrait_Full/files_old/isolates_batch_model_test.csv") 
...
## Flux variance
# high 
pchigh.f <- read.csv("/Users/glmarschmann/.julia/dev/DEBmicroTrait/files/output/isolates_batch_model_fluxes_high.csv")
...
# low
pclow.f <- read.csv("/Users/glmarschmann/.julia/dev/DEBmicroTrait/files/output/isolates_batch_model_fluxes_low.csv")
...
pcflux.f <- read.csv("/Users/glmarschmann/.julia/dev/DEBmicroTrait/files/output/isolates_batch_model_fluxes_low.csv")
